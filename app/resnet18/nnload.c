...
int main(int argc, char *argv[])
{
	...
	if (argc == 1)
	{
		...
		loader->load_partition_range(loader, MODEL_PART_DYNAMIC_NAME, 0, 17, 1); // install into NPU OS #1
	...
	else if (argc == 2)
	{
		if (!strcmp(argv[1], "-undo"))
		{
			...
			loader->unload_partition_range(loader, MODEL_PART_DYNAMIC_NAME, 0, 17, 1); // uninstall into NPU OS #1
		}
	}
}
